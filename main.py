...
class Face_Recognition_System:
    def __init__(self,root):
        ...
        b4 = Button(bg_img,image=self.photoimg5,cursor="hand2",command=self.helpi)
        b4.place(x=1100,y=150,width=200,height=200)

        b1_4 = Button(bg_img,text="Help",cursor="hand2",command=self.helpi)
        ...
        b7 = Button(bg_img,image=self.photoimg8,cursor="hand2",command=self.developers)
        b7.place(x=800,y=500,width=200,height=200)

        b1_7 = Button(bg_img,text="Developer",cursor="hand2",command=self.developers)
        ...
        b1_8 = Button(bg_img,text="Exit",cursor="hand2",command=self.iExit)
    ...
    def iExit(self):
        self.iExit = mb.askyesno("Face Recognition","Are you sure exit this project")
        if self.iExit>0:
            self.root.destroy()
