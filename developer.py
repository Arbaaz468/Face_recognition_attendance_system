...
class Developer:
    def __init__(self,root):
        ...
        Left_frame.place(x=10,y=10,width=600,height=280)
        

        #right label frame
        Right_frame=LabelFrame(main_frame,bd=2,bg="white",relief=RIDGE,text="Second Developer ",font=("times new roman",12,"bold"))
        Right_frame.place(x=620,y=10,width=560  ,height=280)
        
        #bottom label frame
        BOTTOM_frame=LabelFrame(main_frame,bd=2,bg="white",relief=RIDGE,text="Third Developer",font=("times new roman",12,"bold"))
        BOTTOM_frame.place(x=310,y=300,width=600,height=280)
        ...
        f_lbl_BOTTOM = Label(BOTTOM_frame,text="Khushi Tiwari")
        f_lbl_BOTTOM.place(x=10,y=0,width=500,height=40)
